...
$(function() {
	...
	$('#subjectList').datagrid({ 
		...
		style:'width:100%',
		rownumbers:true,
	    url:'Subject_getSubjects.do?subject.status=2',  
		idField:'id',
		treeField:'name',
		singleSelect:true,
		pagination:true,
	    ...
	    toolbar: [
	  		    {
					iconCls: 'icon-add',
					text:'审核',
					handler: function(){edit("Subject_approveInput.do?id=","subjectList")}
				},'-',{
					iconCls: 'icon-reload',
					text:'刷新',
...
<body style="padding: 5px">
	...
	<div id="addWin" class="easyui-window" title="毕业设计选题审核" style="width:600px;height:500px"  
